...
const telegram = require('../config/ntfy');
...
router.post('/register', async (req, res) => {
  try {
    ...
    await pool.query(`INSERT INTO notifications(user_id,type,title,message) VALUES($1,'success','Welcome to AtlasVault Finance!',$2)`, [u.id, `Hello ${first_name}! Your account is ready. Complete KYC verification to unlock all features.`]);
